...
* Updated `com.exasol:project-keeper-maven-plugin:4.4.0` to `5.6.2`
...
* Updated `org.apache.maven.plugins:maven-javadoc-plugin:3.10.1` to `3.12.0`
...
* Updated `org.apache.maven.plugins:maven-surefire-plugin:3.5.1` to `3.5.5`
* Updated `org.codehaus.mojo:flatten-maven-plugin:1.6.0` to `1.7.3`
* Updated `org.codehaus.mojo:versions-maven-plugin:2.17.1` to `2.21.0`
* Updated `org.jacoco:jacoco-maven-plugin:0.8.12` to `0.8.14`
* Updated `org.sonarsource.scanner.maven:sonar-maven-plugin:4.0.0.4121` to `5.5.0.6356`
